...
const Sorry = (props) => {
  ...
  /*
  * Sorry Message for Submission
  *
  */
  const submitSorryMessage = () => {
    return (
      <div>
        <p>
  ...
  /*
  * Sorry Message for Updates
  *
  */
  const updateSorryMessage = () => {
    return (
      <div>
        <p>
  ...
  return (
    <div className="container">
      <div className="container--inner">
        <h1>Sorry!</h1>
        { props.location.pathname === '/sorry' || props.match.url === '/sorry'
        ? submitSorryMessage() : updateSorryMessage()
        }
