...
describe('Giftaid test when user comes from sms,online or call centre', () => {
    ...
    it('verify footer menu', () => {
        cy.get('#footer-menu > li:nth-child(1) > a').should('contain', 'Contact us')
        cy.get('#footer-menu > li:nth-child(2) > a').should('contain', 'Partners')
        cy.get('#footer-menu > li:nth-child(3) > a').should('contain', 'Careers')
        cy.get('#footer-menu > li:nth-child(4) > a').should('contain', 'Legal')
        cy.get('#footer-menu > li:nth-child(5) > a').should('contain', 'Press Area')
        cy.get('#footer-menu > li:nth-child(6) > a').should('contain', 'Reporting concerns')
        cy.get('#footer-menu > li:nth-child(7) > a').should('contain', 'Update your preferences')
        cy.get('#footer-menu > li:nth-child(8) > a').should('contain', 'Privacy')
        cy.get('#footer-menu > li:nth-child(9) > a').should('contain', 'Cookies')
        cy.get('#footer-menu > li:nth-child(10) > a').should('contain', 'FAQs')
        cy.get('#footer-menu > li:nth-child(11) > a').should('contain', 'Accessibility')
        cy.get('#footer-menu > li:nth-child(12) > a').should('contain', 'Sitemap')
        cy.get('#footer-menu > li:nth-child(13) > a').should('contain', 'Modern slavery and human trafficking')
    })
