...
When('I select all the marketing preference options', async function () {
...
When('I enter the valid marketing preference contact details', async function () {
...
When('I select the email marketing preference', async function () {
  await this.page.click(selectors.marketingPreferences.options.email);
});

When('I enter a valid marketing preference email', async function () {
  await this.page.fill(selectors.marketingPreferences.fields.email, email);
});

When('I clear the marketing preference email', async function () {
  await this.page.fill(selectors.marketingPreferences.fields.email, '');
});

When('I enter an invalid marketing preference email {string}', async function (invalidEmail) {
  await this.page.fill(selectors.marketingPreferences.fields.email, invalidEmail);
});

Then('I should see the marketing preference email error {string}', async function (message) {
  await expect(this.page.locator(selectors.errorMessages.email)).toHaveText(message);
});

When('I select the phone marketing preference', async function () {
  await this.page.click(selectors.marketingPreferences.options.phone);
});

When('I enter a valid marketing preference phone', async function () {
  await this.page.fill(selectors.marketingPreferences.fields.phone, phone);
});

When('I clear the marketing preference phone', async function () {
  await this.page.fill(selectors.marketingPreferences.fields.phone, '');
});

When('I enter an invalid marketing preference phone {string}', async function (invalidPhone) {
  await this.page.fill(selectors.marketingPreferences.fields.phone, invalidPhone);
});

Then('I should see the marketing preference phone error {string}', async function (message) {
